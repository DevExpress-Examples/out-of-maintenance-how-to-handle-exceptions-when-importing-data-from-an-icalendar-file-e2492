...
Namespace iCalendarImport
    Partial Public Class Form1
        ...
        Private Sub btnImport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnImport.Click
            ...
            Using fs As MemoryStream = New MemoryStream(buffer)
        ...
        Private Sub ImportAppointments(ByVal stream As Stream)
            If stream Is Nothing OrElse stream Is Stream.Null OrElse stream.Length = 0 Then
                Return
            End If
            Dim importer As iCalendarImporter = New iCalendarImporter(schedulerStorage1)
        ...
        Private Sub importer_OnException(ByVal sender As Object, ByVal e As ExchangeExceptionEventArgs)
            ...
            If args IsNot Nothing Then
                If ckhBreakOnError.Checked Then
                    ...
                    importer.Terminate()
                End If
                ShowErrorMessage(String.Format("Cannot parse line {0} with text '{1}'", _
